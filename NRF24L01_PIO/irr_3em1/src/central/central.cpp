...
const uint64_t endereco_modulo_sensorial = 0xF0F0F0F0AA;
const uint64_t endereco_modulo_irrigacao = 0xF0F0F0F066;
int contador = 0;
float leituras[4];
...
void setup(){
  ...
  radio.openReadingPipe(1, endereco_modulo_sensorial);
  radio.openReadingPipe(2, endereco_modulo_irrigacao);
